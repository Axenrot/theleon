...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-screen overflow-hidden screen-container font-shump">
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-screen select-none">
        ...
        <span className="relative bg-[url('/black-texture.jpg')] bg-fixed z-10 text-transparent duration-1000 cursor-default text-9xl lg:text-[300px] bg-black/90 animate-title font-shump font-bold whitespace-nowrap bg-clip-text -mt-12">
          <h2 className="absolute bottom-[95%] left-1 font-bold text-xl lg:text-2xl text-start text-zinc-700 animate-fade-in">
            Hello, I&apos;m
          </h2>
          <h1 className="">Leon</h1>
