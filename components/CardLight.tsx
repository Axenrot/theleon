...
export const Card: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div
      ...
      className="relative z-10 overflow-hidden h-fit w-full cursor-context-menu duration-700 border-[3px] select-none rounded-xl hover:bg-zinc-800/30 md:gap-8 hover:border-zinc-800/60 border-zinc-800/10 "
    >
      <span className="absolute w-full h-full bg-[url('/black-texture.jpg')] -z-30" />
